...
- [x] **Xbox 360 STFS / CON Packaging & Validation:** STFS package assembler with signed template cloning/patching and automated structure validator (`autorb/export/stfs_validator.py`).
