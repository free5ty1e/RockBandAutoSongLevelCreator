...
- [ ] **Vocal Phrase Marker Generation:** Automatically compute and inject `[vocal_phrase]` start and end markers to enable proper scoring and phrase-based navigation.
- [ ] **Acceptable Pitch Harmony Lines:** Compute diatonic harmony guidelines and secondary pitch pathways for Hard/Expert vocal charts.
