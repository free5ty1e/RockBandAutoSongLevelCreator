...
#if !CORE
  // TupleExtension removed: System.TupleExtensions (netframework reference
  // assemblies) provides Deconstruct for Tuple<T1,T2>, and defining a second
  // one here makes tuple deconstruction ambiguous under the Roslyn build.
#endif
}
